...
const MSG_CREDENTIALS = {
    username: process.env.WHATSAPP_USERNAME || "SBH HOSPITAL",
    password: process.env.WHATSAPP_PASSWORD || "123456789"
};
...
/**
 * Sends WhatsApp message using the configured provider
 */
...
/**
 * Scheduled Function: Runs daily at 9:00 AM IST
 */
exports.dailyMorningReminders = functions.pubsub.schedule("0 9 * * *")
    .timeZone("Asia/Kolkata")
    .onRun(async (context) => {
        console.log("🌅 Starting Daily Morning Automated Reminders...");
        const todayStr = getTodayStr();

        try {
            // 1. Check/Mark Delays in CMS
...
/**
 * Marks tickets as Delayed if they are Open/Pending and older than 24 hours
 */
...
/**
 * Complaint Escalation Reminders
 */
async function checkComplaintReminders(todayStr) {
    ...
    // Cache department mobiles to avoid repeated fetches
    const deptCache = {};
