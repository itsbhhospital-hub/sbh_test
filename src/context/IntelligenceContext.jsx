import React, { useState, useCallback, useRef, useEffect, useContext, createContext, useMemo } from 'react';
...
export const IntelligenceProvider = ({ children }) => {
    ...
    const refreshIntelligence = useCallback(async (isManual = false) => {
